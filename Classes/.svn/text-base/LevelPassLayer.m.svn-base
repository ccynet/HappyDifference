...
-(id) initWithLayer:(ClassicDifGameLayer*) layer
{
    if((self = [super initWithColor:ccc4(51,51,51,128)]))
    {
        ...
        if(m_layer.m_iCurStage == [UserData sharedUserData].m_iPassStageNo
           &&m_layer.m_iCurLevel == [UserData sharedUserData].m_iPassLevel)
            [UserData sharedUserData].m_iPassLevel = m_layer.m_iCurLevel+1;
        
        //bk
        CGSize winSize = [[CCDirector sharedDirector] winSize];
        CCSprite*  passStagebk = [[[CCSprite alloc]initWithFile:@"passstage.png"]autorelease];
        [passStagebk setPosition:CGPointMake(winSize.width/2, 350)];
        [self addChild:passStagebk];
        ...
        CCMenuItemImage*    goItemImage = [CCMenuItemImage itemFromNormalImage:@"next.png" 
                                                                 ...
                                                                 disabledImage:@"" target:self selector:@selector(ToNextLevel)];
